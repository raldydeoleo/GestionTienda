...
namespace BoxTrackLabel.API.Migrations.BoxTrackLabelMigrations
{
    ...
    [Migration("20220406133805_Productos")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BoxTrackLabel.API.Models.EmailAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("DataMatrix_EmailAccounts");
                });
            ...
            modelBuilder.Entity("BoxTrackLabel.API.Models.Label", b =>
                {
                    ...
                    b.Property<int>("IdEtiquetaReimpresa");
            ...
            modelBuilder.Entity("BoxTrackLabel.API.Models.Productos", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("BoxTrackLabel.API.Models.Productos_Prov", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<Guid>("SuplidorId");

                    b.HasKey("Id");

                    b.HasIndex("SuplidorId");

                    b.ToTable("Productos_Prov");
                });
            ...
            modelBuilder.Entity("BoxTrackLabel.API.Models.Suplidores", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("BoxTrackLabel.API.Models.Productos_Prov", b =>
                {
                    b.HasOne("BoxTrackLabel.API.Models.Suplidores", "Suplidores")
                        .WithMany()
            ...
            modelBuilder.Entity("BoxTrackLabel.API.Models.Suplidores", b =>
                {
                    b.HasOne("BoxTrackLabel.API.Models.Productos")
                        .WithMany("suplidores")
